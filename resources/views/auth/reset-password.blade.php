    ...
    <div class="lg:col-span-7 p-6 sm:p-8 lg:p-10 flex flex-col justify-between bg-surface-container-lowest overflow-y-auto">
      ...
      <div>
        ...
        <form method="POST" action="{{ route('password.update') }}" class="space-y-3">
          ...
          <div>
            <label class="block text-xs font-semibold text-on-surface mb-1">Password Baru</label>
            <div class="relative flex items-center">
          ...
          <div>
            <label class="block text-xs font-semibold text-on-surface mb-1">Konfirmasi Password Baru</label>
            <div class="relative flex items-center">
